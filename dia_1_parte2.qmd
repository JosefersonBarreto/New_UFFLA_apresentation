...
para mais temas e customisações confira a documentação da biblioteca **shinythemes** @shinythemes
...
Vamos fazer a análise exploratória,primeiramente vamos observar os tipos de variáveis
...
A moda é o valor que ocorre com mais frequência em uma distribuição de dados. Vamos utilizar o código abaixo para calcular a moda:
