...
![](images/clipboard-1023669590.png){width="597" height="274"}
...
## <font color= "purple"> CSS </font> {.maria style="color: purple;"}

![](images/clipboard-1023669590.png){width="597" height="278"}

No trecho seguinte em body( corpo do documento) passamos novamente a cor de corpo com um tom específico de azul.
...
As melhores configurações e padrões de CSS vai depender muito do seu tipo de documento, por exemplo, ele pode ser um dashboard, ou uma pagina em HTML, cabe a você pesquisar e configurar os elementos a seu gosto.

# Continuando

# Continuando

Agora que já vimos uma breve introdução aos elementos que compoem um arquivo Quarto básico, podemos prosseguuir com o nosso mini curso.
